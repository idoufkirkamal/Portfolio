...
const Badge = ({containerStyle, icon, endCountNum, endCountText, BadgeText}) => {
  return <div className={`z-10 w-auto min-w-[200px] h-[68px] bg-light dark:backdrop-blur-[44px] shadow-2xl p-4 rounded-[10px] flex items-center gap-x-4 ${containerStyle}`}>
